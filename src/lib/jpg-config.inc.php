...
// define('TTF_DIR','/usr/share/fonts/truetype/msttcorefonts/'); //MiToTeam: defined in jpgraph.php:209 with better default value OS-dependent detection
...
if(!defined('CSIMCACHE_DIR')) define('CSIMCACHE_DIR', 'csimcache/');
if(!defined('CSIMCACHE_HTTP_DIR')) define('CSIMCACHE_HTTP_DIR','csimcache/');
...
if(!defined('DEFAULT_ERR_LOCALE')) define('DEFAULT_ERR_LOCALE','en');

// Deafult graphic format set to 'auto' which will automatically
// choose the best available format in the order png,gif,jpeg
// (The supported format depends on what your PHP installation supports)
if(!defined('DEFAULT_GFORMAT')) define('DEFAULT_GFORMAT','auto');
...
if(!defined('READ_CACHE')) define('READ_CACHE',true);

// Determine if the error handler should be image based or purely
// text based. Image based makes it easier since the script will
// always return an image even in case of errors.
if(!defined('USE_IMAGE_ERROR_HANDLER')) define('USE_IMAGE_ERROR_HANDLER',true);
...
if(!defined('CATCH_PHPERRMSG')) define('CATCH_PHPERRMSG',true);
...
if(!defined('INSTALL_PHP_ERR_HANDLER')) define('INSTALL_PHP_ERR_HANDLER',false);

// Should usage of deprecated functions and parameters give a fatal error?
// (Useful to check if code is future proof.)
if(!defined('ERR_DEPRECATED')) define('ERR_DEPRECATED',true);
...
// GD function thinks.
if(!defined('USE_LIBRARY_IMAGETTFBBOX')) define('USE_LIBRARY_IMAGETTFBBOX',true);
...
if(!defined('CACHE_FILE_GROUP')) define('CACHE_FILE_GROUP','www');

// What permissions should the cached file have
// (Set to '' will give the default persmissions for the 'PHP-user')
if(!defined('CACHE_FILE_MOD')) define('CACHE_FILE_MOD',0664);

// Default theme class name
if(!defined('DEFAULT_THEME_CLASS')) define('DEFAULT_THEME_CLASS', 'UniversalTheme');

if(!defined('SUPERSAMPLING')) define('SUPERSAMPLING', true);
if(!defined('SUPERSAMPLING_SCALE')) define('SUPERSAMPLING_SCALE', 1);
